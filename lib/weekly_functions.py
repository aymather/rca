...
def cacheArtistDiscoveryStats(db):
    ...
    def cache_youtube(db, reporting_db, youtube_ids):
        ...
        elapsedTime = round(trackTime() - timeStart, 2)
        print(f'\nTime: {elapsedTime}')
        ...
        db.big_insert(meta, table)

    def cache_tiktok(db, reporting_db, tiktok_ids):
    ...
    def cache_spotify(db, reporting_db, spotify_ids):
    ...
    def cache_instagram(db, reporting_db, instagram_ids):
    ...
    cache_youtube(db, reporting_db, youtube_ids)
    cache_tiktok(db, reporting_db, tiktok_ids)
    cache_spotify(db, reporting_db, spotify_ids)
    cache_instagram(db, reporting_db, instagram_ids)
